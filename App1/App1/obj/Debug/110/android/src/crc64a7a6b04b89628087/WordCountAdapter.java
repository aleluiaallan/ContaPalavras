...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("App1.WordCountAdapter, App1", WordCountAdapter.class, __md_methods);
	}


	public WordCountAdapter ()
	{
		super ();
		if (getClass () == WordCountAdapter.class)
			mono.android.TypeManager.Activate ("App1.WordCountAdapter, App1", "", this, new java.lang.Object[] {  });
	}
